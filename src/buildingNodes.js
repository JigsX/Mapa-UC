...
function buildingNodes(buildingName) {
    ...
    if (buildingName == "science2ndFloor") {
        ...
        nodes = [
            ...
            { id: 15, lat: 6.8, lon: 2.88,  }, {lat: 8.1, lon: 2.87, title: 'office',building:'Science', floor:'2nd Floor',node: 15,label: 'classroomLogo' },
            ...
            { id: 61, lat: 3.84, lon: 5.65,  }, { lat: 4.4, lon: 5.5, title: 'classRoom',building:'Science', floor:'2nd Floor',node: 61,label: 'classroomLogo' },
